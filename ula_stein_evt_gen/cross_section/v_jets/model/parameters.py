#  MadGraph5_aMC@NLO v. 3.6.2, 2025-03-19
#  By the MadGraph5_aMC@NLO Development Team
#  Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch

import model.madjax_patch as cmath
from model.madjax_patch import complex
...
def calculate_full_parameters(slha):
        ...
        _result_params["GC_10"] = complex(GC_10)
        _result_params["GC_11"] = complex(GC_11)
        _result_params["GC_12"] = complex(GC_12)
